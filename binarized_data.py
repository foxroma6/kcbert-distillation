...
def main():
    ...
    parser.add_argument('--tokenizer_type', type=str, default='bert', choices=['bert', 'roberta', 'gpt2', 'kcbert'])
    ...
    elif args.tokenizer_type == 'kcbert':
    ...
    dp_file = f'{args.dump_file}.kcbert.pickle'
